...
namespace LMS.WEB.Portal
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<DataBaseContext>(o => o.UseSqlServer(Configuration.GetConnectionString("LMSDB")));
            ...
            services.AddSingleton<ILoginUserMapper, LoginUserMapper>();
            services.AddSingleton<IEmployeeDetailsMapper, EmployeeDetailsMapper>();
            services.AddSingleton<ILeaveMapper, LeaveMapper>();
            services.AddSingleton<ILeaveTypeMapper, LeaveTypeMapper>();
        }
